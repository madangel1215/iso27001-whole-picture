# ISMS 主導稽核員 · 互動課程筆記（ISMS LA · ISO/CNS 27001:2023）

ISMS 主導稽核員（ISMS Lead Auditor）課程的**互動筆記** —— 能學、能查、能拿去稽核。把資訊安全管理系統（ISMS）的「whole picture」做成會講解自己的互動圖：純靜態、暗色高級質感、點任一節點看白話說明＋對應 ISO 27001 條款＋稽核三件組，三張架構圖互相扣。
